import { createEffect, createSignal, Index, type Component } from 'solid-js';
  ...
  return (
    <div class="text-center">
      <header class="bg-slate-800 min-h-screen flex flex-col items-center justify-center text-white">
        <img src={logo} class="logo-spin h-80" alt="logo" />

        <TextPrompt userTypedText={typedText()} />
        <input type="text" value={typedText()} onInput={handleInput} />
      </header>
    </div>
  );
};
